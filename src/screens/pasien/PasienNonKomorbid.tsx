...
import {
  usePasienNonKomorbid,
  usePasienNonKomorbidForm,
} from "../../hooks/pasien/pasienNonKomorbidHooks";
...
const PasienNonKomorbid = () => {
  //  Custom Hooks
  const State = usePasienNonKomorbid();
  // Local State
  ...
  // Formik Custom Hooks
  const Form = usePasienNonKomorbidForm({ onSubmit: handleSubmit });
  // Use Effect
  useEffect(() => {
    State.handleGetAll();
  }, []);
    ...
    <>
      ...
      <div>
        <h1 className="text-2xl text-gray-800 my-4">
          Rekap Pasien Dirawat Tanpa Komorbid
        </h1>
        ...
        <div className="my-2">
          {State.error?.getAll ? (
            <ErrorBox
              errorTitle="Gagal Menarik Rekap Data Pasien Tanpa Komorbid"
...
export default PasienNonKomorbid;
